                                ...
                                <tr>
                                    ...
                                    <td>
                                        <form action="{{ route('receipts.destroy',$receipt->idReceipt) }}" method="POST">                                   
                                            <a onclick="showDetailReceipt('{{$detail}}', '{{$menu}}','{{$topping}}', '{{$detailTopping}}', '{{$detailWeekly}}', '{{$receipt->idReceipt}}', '{{$receipt->idDetailWeeklyBook}}')" type="button" style="background-color: #B78546; border-color: #B78546" class="btn btn-info" data-toggle="modal" data-target="#myModal">Show</a>                                          
